...
import stipeConfig from '../lib/stripe';
...
async function checkout(
  ...
  // 2. Calculate the total price for theri order
  ...
  const charge = await stipeConfig.paymentIntents.create({
    amount,
    currency: 'USD',
    confirm: true,
